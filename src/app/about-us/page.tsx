  ...
  return (
    <main className="min-h-screen bg-[#0b0d0f] text-gray-200 flex flex-col items-center px-6 py-20">
      <div className="max-w-4xl w-full text-center">
        ...
        {/* Mission Section */}
        <section className="bg-[#111317] border border-gray-800 rounded-2xl p-8 mb-12 text-left shadow-lg shadow-blue-900/10">
...
function ValueCard({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="bg-[#111317] border border-gray-800 rounded-2xl p-6 text-left hover:border-blue-500/40 hover:bg-blue-500/5 transition-all duration-200">
